...
#For relays to work correctly you have to tell the computer what to do for each 
# possible condition of LDRs. You can alter sleep time for more responsivenes, but beweary of 
# using all your cpu power. without sleeps code will perform as fast as the processor can handle.
#sleep is bassed on process time(relative to processor speed) and not real time.
